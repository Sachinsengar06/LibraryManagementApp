...
namespace BusinessLogicLayer.Jwt_Token
{
   public class AuthenticationService:IAuthenticateService
        {
              private readonly string _secretKey = "GenerateRandomKey128Bits"; // Replace with a secure secret key
              private readonly string _issuer = "http://localhost:4200"; // Replace with your issuer
